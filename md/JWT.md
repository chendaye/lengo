...
- [JWT](#jwt)
  - [TOKEN](#token)
    - [API 鉴权](#api-%E9%89%B4%E6%9D%83)
      - [cookie + session](#cookie--session)
      - [HTTP Basic](#http-basic)
      - [HTTP Digest](#http-digest)
      - [Token](#token)
    - [Token 的优势](#token-%E7%9A%84%E4%BC%98%E5%8A%BF)
      - [CSRF 攻击](#csrf-%E6%94%BB%E5%87%BB)
      - [适合移动应用](#%E9%80%82%E5%90%88%E7%A7%BB%E5%8A%A8%E5%BA%94%E7%94%A8)
    - [Token 的种类](#token-%E7%9A%84%E7%A7%8D%E7%B1%BB)
  - [JWT 的组成和优势](#jwt-%E7%9A%84%E7%BB%84%E6%88%90%E5%92%8C%E4%BC%98%E5%8A%BF)
    - [组成](#%E7%BB%84%E6%88%90)
      - [头部（header）](#%E5%A4%B4%E9%83%A8header)
      - [载荷（Payload）](#%E8%BD%BD%E8%8D%B7payload)
        - [公有的载荷](#%E5%85%AC%E6%9C%89%E7%9A%84%E8%BD%BD%E8%8D%B7)
        - [私有载荷](#%E7%A7%81%E6%9C%89%E8%BD%BD%E8%8D%B7)
      - [签名（Signature）](#%E7%AD%BE%E5%90%8Dsignature)
      - [使用](#%E4%BD%BF%E7%94%A8)
      - [相对于一般 token 的优点](#%E7%9B%B8%E5%AF%B9%E4%BA%8E%E4%B8%80%E8%88%AC-token-%E7%9A%84%E4%BC%98%E7%82%B9)
    - [JWT 的安全问题](#jwt-%E7%9A%84%E5%AE%89%E5%85%A8%E9%97%AE%E9%A2%98)
      - [重放攻击](#%E9%87%8D%E6%94%BE%E6%94%BB%E5%87%BB)
      - [token 被盗](#token-%E8%A2%AB%E7%9B%97)
    - [JWT 的其他问题](#jwt-%E7%9A%84%E5%85%B6%E4%BB%96%E9%97%AE%E9%A2%98)
      - [注销问题](#%E6%B3%A8%E9%94%80%E9%97%AE%E9%A2%98)
      - [续签问题](#%E7%BB%AD%E7%AD%BE%E9%97%AE%E9%A2%98)
        - [方式一](#%E6%96%B9%E5%BC%8F%E4%B8%80)
        - [方式二](#%E6%96%B9%E5%BC%8F%E4%BA%8C)
        - [黑名单膨胀的解决方案](#%E9%BB%91%E5%90%8D%E5%8D%95%E8%86%A8%E8%83%80%E7%9A%84%E8%A7%A3%E5%86%B3%E6%96%B9%E6%A1%88)
        - [总结](#%E6%80%BB%E7%BB%93)
    - [JWT 适合用来做什么](#jwt-%E9%80%82%E5%90%88%E7%94%A8%E6%9D%A5%E5%81%9A%E4%BB%80%E4%B9%88)
      - [无状态的 RESTful API](#%E6%97%A0%E7%8A%B6%E6%80%81%E7%9A%84-restful-api)
      - [SSO 单点登录](#sso-%E5%8D%95%E7%82%B9%E7%99%BB%E5%BD%95)
    - [JWT 与 Oauth2.0](#jwt-%E4%B8%8E-oauth20)
...
- 时间换空间：因为 token 的校验时通过签名校验来进行的，签名校验消耗的是 CPU 时间，而『有状态』是需要通过客户端提供的凭据对服务端现有的
- 状态进行一次查询，消耗的是 I/O 和内存、磁盘空间。通常对于一个 Web 服务来说，其属于 I/O 密集型，因此通过时间换空间这一操作，可以提高整体的硬件使用率。
...
**也就是，最开始的token在 1h内无条件有效；在2h~3h 内发送请求，最开始的token过期，会自动更换新的token，完成续签**
...
>>app
和web 端类似，设置成更长的时间周期即可。

<br>

**问题**
>对使用 Laravel 开发并使用 tymon/jwt-auth 这个插件的开发者，有个必须要注意的地方。
>>此处进行 token 的刷新并不是通过 refresh 这个操作获得新 token，因为这样 token 在不断的刷新过程中会达到一个刷新时间的上限。
>>上面的逻辑是每次都新签发一个 token，只要不断签就能够一直使用下去。 然后这里的旧 token 放入黑名单，黑名单有效期设置为『刷新时间』—— 3h。
...
>如果要解决续签问题，
>>方式一【可以一直续签】是个比较好的解决方案，虽然会带来一点小问题，但是并不会有太大的影响。
方式二【限定不能一直续签】和 每次刷新会让黑名单的维护量和有状态差不多，但是有更高的安全性
